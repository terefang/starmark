...
public class ResourceHelper
{
    ...
    static class UrlModifier extends AbstractModifyingCSSUrlVisitor
    {
        ...
        {
             _url = ResourceHelper.findResource(_url, this.getResDirs()).getAbsolutePath();
             return ResourceHelper.resourceToDataUrl(_url);
        }
    }
    ...
    public static String stringifyCss(String _css, List<File> _rd)
    {
        ...
        _sw.write("<style type=\"text/css\">\n/*<![CDATA[*/\n");
        _w.writeCSS(_doc, _sw);
        _sw.write("\n/*]]>*/\n</style>\n");
        return _sw.getBuffer().toString();
        // return MessageFormat.format("<link rel=\"stylesheet\" type=\"text/css\" href=\"{0}\" >", _css);
    }
